...
public abstract class AdditiveHairHighAndTight extends CharacterDecorator {

    public AdditiveHairHighAndTight(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "hair_high_and_tight_white"), Base64.DEFAULT);
