...
public abstract class AdditiveHairLongMessy extends CharacterDecorator {

    public AdditiveHairLongMessy(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "hair_long_messy_white"), Base64.DEFAULT);
