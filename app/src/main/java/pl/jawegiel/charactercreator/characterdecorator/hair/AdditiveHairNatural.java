...
public abstract class AdditiveHairNatural extends CharacterDecorator {

    public AdditiveHairNatural(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "hair_natural_white"), Base64.DEFAULT);
