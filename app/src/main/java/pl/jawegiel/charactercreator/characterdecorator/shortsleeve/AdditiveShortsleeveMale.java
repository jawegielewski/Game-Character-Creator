...
public abstract class AdditiveShortsleeveMale extends CharacterDecorator {

    public AdditiveShortsleeveMale(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "shortsleeve_male_white"), Base64.DEFAULT);
    ...
    public SpriteElement getSpriteElement() {
        return SpriteElement.SHORTSLEEVE_MALE;
    }
}
