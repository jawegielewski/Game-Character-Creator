...
public abstract class AdditivePantsFemale extends CharacterDecorator {

    public AdditivePantsFemale(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "pants_female_white"), Base64.DEFAULT);
    ...
    public SpriteElement getSpriteElement() {
        return SpriteElement.PANTS_FEMALE;
    }
}
