...
public abstract class AdditiveShoesMale extends CharacterDecorator {

    public AdditiveShoesMale(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "shoes_male_white"), Base64.DEFAULT);
    ...
    public SpriteElement getSpriteElement() {
        return SpriteElement.SHOES_MALE;
    }
}
