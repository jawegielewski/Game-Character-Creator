...
public abstract class AdditiveShortsleeveFemale extends CharacterDecorator {

    public AdditiveShortsleeveFemale(Character baseCharacter) {
    ...
    public void passLook(IOnSpriteGet onSpriteGet) {
        byte[] decodedString = Base64.decode(AppConstants.getSpriteString(context, "shortsleeve_female_white"), Base64.DEFAULT);
    ...
    public SpriteElement getSpriteElement() {
        return SpriteElement.SHORTSLEEVE_FEMALE;
    }
}
